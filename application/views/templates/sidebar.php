    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="<?= base_url('Dashboard/search') ?>" method="post">
            <div class="input-group">
              <select type="text" class="form-control bg-light border-0 small" aria-label="Search" aria-describedby="basic-addon2" name="keyword">
                <option>Search for ....</option>
            <?php $query = $this->db->get('tb_kategori')->result();
              foreach ($query as $k) : ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="navbar">
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <?php $cart = '<i class="fas fa-shopping-cart"></i>' ?>
