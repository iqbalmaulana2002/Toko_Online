  ...
  <div class="row text-center mt-4">
    <?php foreach ($barang as $brg): ?>
        <div class="card ml-2 mb-3" style="width: 16rem;">
          <img src="<?= base_url().'/uploads/'. $brg->gambar ?>" class="card-img-top" alt="..." style="width: 200px; height: 140px" >
          <div class="card-body">
          ...
          <?= anchor('Dashboard/detail/'. $brg->id_barang, '<div class="btn btn-sm btn-success">Detail</div>') ?>
          </div>
      </div>
    <?php endforeach ?>
  </div>
